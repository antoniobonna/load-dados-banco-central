# -*- coding: utf-8 -*-
"""
Created on Fri Oct  4 17:14:55 2019
...
new_file = 'clientes_operaçoes.csv'
files = [f for f in os.listdir(indir) if os.path.isfile(indir+f) and 'clientes_operações' in f]
columns = ['Instituição financeira','Código','Segmento','Cidade','UF','Data','Quantidade de Clientes','Quantidade de Operações']
tablename = 'dados_banco_central.clientes_operacoes_stg'
